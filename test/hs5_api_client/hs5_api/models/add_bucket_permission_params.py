...
class AddBucketPermissionParams(BaseModel):
    """
    AddBucketPermissionParams
    """ # noqa: E501
    user_id: StrictStr = Field(alias="userId")
    bucket_name: StrictStr = Field(alias="bucketName")
    add_bucket_permissions: List[StrictStr] = Field(alias="addBucketPermissions")
    __properties: ClassVar[List[str]] = ["userId", "bucketName", "addBucketPermissions"]

    @field_validator('add_bucket_permissions')
    def add_bucket_permissions_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addBucketPermissions": obj.get("addBucketPermissions")
        })
        return _obj
