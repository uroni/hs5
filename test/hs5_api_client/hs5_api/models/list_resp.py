...
class ListResp(BaseModel):
    ...
    ListResp
    """ # noqa: E501
    objects: List[ListRespObjectsInner]
    next_marker: StrictStr = Field(alias="nextMarker")
    is_truncated: StrictBool = Field(alias="isTruncated")
    __properties: ClassVar[List[str]] = ["objects", "nextMarker", "isTruncated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "objects": [ListRespObjectsInner.from_dict(_item) for _item in obj["objects"]] if obj.get("objects") is not None else None,
