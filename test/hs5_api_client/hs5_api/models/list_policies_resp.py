...
class ListPoliciesResp(BaseModel):
    """
    ListPoliciesResp
    """ # noqa: E501
    policies: List[ListPoliciesRespPoliciesInner]
    next_marker: StrictStr = Field(alias="nextMarker")
    is_truncated: StrictBool = Field(alias="isTruncated")
    __properties: ClassVar[List[str]] = ["policies", "nextMarker", "isTruncated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policies": [ListPoliciesRespPoliciesInner.from_dict(_item) for _item in obj["policies"]] if obj.get("policies") is not None else None,
