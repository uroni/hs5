...
class ListRolesResp(BaseModel):
    """
    ListRolesResp
    """ # noqa: E501
    roles: List[ListRolesRespRolesInner]
    next_marker: StrictStr = Field(alias="nextMarker")
    is_truncated: StrictBool = Field(alias="isTruncated")
    __properties: ClassVar[List[str]] = ["roles", "nextMarker", "isTruncated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "roles": [ListRolesRespRolesInner.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
